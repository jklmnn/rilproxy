...
function sl3p.dissector(buffer, pinfo, tree)
    ...
    local subtree = tree:add(sl3p, buffer(), "SL3P S:" .. buffer(4, 4):uint() .. " L:" .. buffer(8, 4):uint())
    subtree:add(buffer(0, 8), "Sequence number: " .. buffer(4, 4):uint()) --buffer should be (0, 8) but we cant handle 8byte int types with lua...
